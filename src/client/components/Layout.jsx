        ...
        <>
                ...
                <header className={styles.header}>
                    <div className={styles.headerTitle}>
                        ...
                        <NavLink to="/stats" activeClassName={activeClassName}>
                            <h2 className={`${styles.title} ${styles.stats}`}>
                                Stats
                            </h2>
                        </NavLink>
                    </div>
            ...
            {!introDismissed && (
                <div className={styles.intro}>
                    <p>
                        Hey, welcome to Phrase Tutor. Let's learn Italian
                        language by learning the 96 phrases we prepared.
                    </p>
                    <p>
                        The system will first ask you all of the phrases. Then
                        it will prioritise the phrases you didn't know. Just
                        keep hitting next until you are 100% correct 😊
                    </p>
                    <p>
                        <strong>Quick tutorial:</strong> when you see a phrase,
                        try to remember the translation. If you know it, hit "I
                        knew it", otherwise hit "Nope".
                    </p>
                    <div>
